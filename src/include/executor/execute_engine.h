...
private:
  ...
  bool RowSatisfyCondition(Row &row, pSyntaxNode cond_root_ast, TableInfo *tinfo, ExecuteContext *context);//judge if a row satisfy the condition generated by the tree
