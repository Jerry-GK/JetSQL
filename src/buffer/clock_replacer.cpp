...
ClockReplacer::ClockReplacer(size_t size)
    : num_pages_(size), num_present_(0), present_(new bool[size]), ref_(new bool[size]), clock_pointer_(0) {
...
size_t ClockReplacer::Size() { return num_present_; }
